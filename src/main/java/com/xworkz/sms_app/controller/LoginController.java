...
import com.xworkz.sms_app.service.LoginService;
		...
		try {
			...
			if (dto.getUserName().equals(username)) {
				if (loginService.generateOTP())
					modelAndView.addObject("Successmsg", "One-time password has been sent to your Email id, which is valid for 10min.");
